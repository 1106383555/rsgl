...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<%=path%>/newsinfo_update.action" method="post" id="addForm">
                 <input name="id" type="hidden" value="${newsinfo.id}"/>
                 <input name="fbsj" type="hidden" value="${newsinfo.fbsj}"/>
                <div class="container-fluid">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                            ...
                                            <input id="title" name="title" size="35" class="form-control"   type="text" value="${newsinfo.title}"  tip="请输入标题" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function(){
    ...
    ue.ready(function() {
        //设置编辑器的内容
        ue.setContent('${newsinfo.contents}');
    });
