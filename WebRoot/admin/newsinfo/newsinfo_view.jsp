                ...
                <div class="container-fluid">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 form-inline" >
                                                                                    <input id="title" name="title" size="35" value="${newsinfo.title}" readonly="readonly" class="form-control" type="text"  />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 form-inline" >
                                                                                    <input id="fbsj" name="fbsj" size="35" value="${newsinfo.fbsj}" readonly="readonly" class="form-control" type="text"  />
                                    </div>
                                </div>
                            </div>
                        </div>
