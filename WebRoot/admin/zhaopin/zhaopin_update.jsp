...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<%=path%>/zhaopin_update.action" method="post" id="addForm">
                 <input name="id" type="hidden" value="${zhaopin.id}"/>
                 <input name="fbsj" type="hidden" value="${zhaopin.fbsj}"/>
                <div class="container-fluid">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                            ...
                                            <input id="name" name="name" size="35" class="form-control"   type="text" value="${zhaopin.name}"  tip="请输入职位" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function(){
    ...
    ue.ready(function() {
        //设置编辑器的内容
        ue.setContent('${zhaopin.contents}');
    });
